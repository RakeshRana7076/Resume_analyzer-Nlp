...
connection = pymysql.connect(host='localhost', user='root', password='Mca@123')
    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                st.balloons()
                if (resume_score>=60):
                     st.success( "You are Eligible for interview"  )
        ...
        if st.button('Login'):
            if ad_user == 'Rakesh Rana' and ad_password == 'Rakesh@123':
